...
def collate_fn(batch):
    ...
    doc_rel = [f["doc_rel"] for f in batch if "doc_rel" in f]
    ...
    if  doc_rel == []:
        doc_rel = None
    hts_graph = [f['hts_graph'] for f in batch]
    output = (input_ids, input_mask, labels, entity_pos, hts, sent_pos, sent_labels_tensor, attns, doc_rel, hts_graph)
